...
const SECTIONS: Section[] = [
    ...
    body: (
      <ol className="space-y-3">
        <li className="flex gap-3">
          <span
            className="grid h-6 w-6 shrink-0 place-items-center rounded-full font-mono text-[11px] font-bold text-orange-300"
            style={{
          ...
          <div>
            <div className="font-medium text-slate-200">用手机拍 1-3 张产品照</div>
        ...
        <li className="flex gap-3">
          ...
          <div>
            <div className="font-medium text-slate-200">选场景 + 上传</div>
            <div className="text-[11px] leading-relaxed text-slate-400">
              <span className="text-orange-300">主图</span>用「📷 抠图换纯白底」，
              <span className="text-orange-300">附图</span>挑「大理石晨光 / 木质农舍 / 北欧极简 / 工业不锈钢」之一，
              <span className="text-orange-300">A+</span>用「Hero Banner 产品图」。点上传区把产品照丢进去。
            </div>
          </div>
        </li>
        <li className="flex gap-3">
          ...
          <div>
            <div className="font-medium text-slate-200">点生成 → 等 6-20 秒出图</div>
            <div className="text-[11px] leading-relaxed text-slate-400">
        ...
        <li className="flex gap-3">
          ...
          <div>
            <div className="font-medium text-slate-200">下载 → upscale → 上传 ASIN</div>
            <div className="text-[11px] leading-relaxed text-slate-400">
  ...
  },
  {
    ...
    body: (
      <div className="space-y-3 text-[11px] leading-relaxed text-slate-400">
        <div>
          <div className="mb-1.5 font-medium text-slate-200">主图（Main Image）— 强制规则</div>
          <ul className="ml-3 space-y-1 list-disc marker:text-orange-400/60">
            <li>纯白背景：<span className="font-mono text-orange-200">RGB 255, 255, 255</span>（off-white、灰底都会被拒）</li>
            <li>最低分辨率：<span className="font-mono text-orange-200">1000 × 1000 px</span>（触发放大功能必须达到）</li>
            <li>推荐分辨率：<span className="font-mono text-emerald-300">2000 × 2000 px 以上</span>，甜区 2000-3000</li>
            <li>仅产品本体，<span className="text-amber-200">不能有人物、配件、文字、logo、水印</span></li>
            <li>产品占图 ≥ 85%</li>
            <li>对焦清晰 + 真实色彩，**不能用展示框/模型图**</li>
          </ul>
        </div>
        <div>
          <div className="mb-1.5 font-medium text-slate-200">附图（Additional Images）— 限制宽松</div>
          <ul className="ml-3 space-y-1 list-disc marker:text-orange-400/60">
        ...
        <div>
          <div className="mb-1.5 font-medium text-slate-200">通用技术规格</div>
          <ul className="ml-3 space-y-1 list-disc marker:text-orange-400/60">
            <li>文件格式：<span className="font-mono">JPEG / PNG / TIFF / GIF</span>（不允许动画 GIF）</li>
            <li>文件体积：<span className="font-mono text-orange-200">≤ 10 MB / 张</span></li>
            ...
            <li>每个 ASIN 最多 <span className="font-mono text-orange-200">9 张图</span>（部分类目还可以 1 个视频）</li>
          </ul>
        </div>
        <div>
          <div className="mb-1.5 font-medium text-slate-200">A+ Content（品牌内容）</div>
          <ul className="ml-3 space-y-1 list-disc marker:text-orange-400/60">
  ...
  },
  {
    ...
    body: (
      <div className="space-y-3 text-[11px] leading-relaxed text-slate-400">
        <div>
          <div className="font-medium text-slate-200">Q: AI 把我的产品形状/颜色改了怎么办？</div>
          <div className="mt-0.5">
            场景已经在 prompt 里硬编码"keep the product EXACTLY identical"。如果还是变了，
            <strong className="text-orange-300">换更高质量的模型</strong>：把 preset 切到「📷 工业不锈钢」
            或「📷 A+ Hero Banner 产品图」（这两个用的是 Nano Banana <strong>Pro</strong>，
            形状保真比 v1/v2 强一截，¥1.08/张）。或者再上传一张更清晰的正面照。
          </div>
        </div>
        <div>
          <div className="font-medium text-slate-200">Q: 主图生成后背景看着不够白？</div>
          <div className="mt-0.5">
            肉眼看不出来不代表 RGB 255。建议过一道
            <strong className="text-orange-300">remove.bg / Photoshop 抠图</strong>
            把背景重新铺成纯白再传。或者拿到 Photoshop 里"色阶"把白点拉到 255。
            亚马逊审核很严，灰白会被退。
          </div>
        </div>
        <div>
          <div className="font-medium text-slate-200">Q: 1024×1024 出图够亚马逊主图用吗？</div>
          <div className="mt-0.5">
            <strong className="text-amber-300">勉强达标但不推荐</strong>。
            亚马逊主图 1000×1000 才能触发放大镜功能，1024 是过线。但 2000+ 才能让放大体验好。
            建议出图后再用：
            <ul className="ml-3 mt-1 list-disc marker:text-orange-400/60">
        ...
        <div>
          <div className="font-medium text-slate-200">Q: 上传的产品照会被存到哪？</div>
          <div className="mt-0.5">
            <strong className="text-emerald-300">不会上服务器</strong>。
        ...
        <div>
          <div className="font-medium text-slate-200">Q: 一张图 1.08 元，跑批 10 张就 10 块，能不能更便宜？</div>
          <div className="mt-0.5">
  ...
  },
  {
    ...
    body: (
      <ul className="space-y-2 text-[11px] leading-relaxed text-slate-400">
        <li>
          <strong className="text-orange-300">多角度上传：</strong>
          上传 2-3 张同一产品不同角度（正面 + 45° + 侧面），Nano Banana Pro 会综合使用，
          出图角度更可控、形状更准。
        </li>
        <li>
          <strong className="text-orange-300">用产品照 + 包装盒：</strong>
          一张产品独立照 + 一张产品+包装合影 → 选"包装展示"的自由风格 prompt，
          生成更高级的开箱合成图。
        </li>
        <li>
          <strong className="text-orange-300">A+ Hero 留位法：</strong>
          用 16:9 留出右侧 2/3 空间（preset 已经在 prompt 里指定）；
          下载后到 Canva / Figma 加 Slogan 文字。比直接 Ideogram 写文字可控得多。
        </li>
        <li>
          <strong className="text-orange-300">批量出图：</strong>
          准备 5 个 ASIN？依次切换 preset，每个 preset 跑 1 张草图（¥0.58 × 5 ≈ ¥3），
          挑出风格满意的再用 Pro 出最终稿。
        </li>
        <li>
          <strong className="text-orange-300">提示词复刻：</strong>
          每次出图后展开"查看完整 prompt"，复制保存到 Notion；下次同款产品改一个词就复用。
        </li>
        <li>
          <strong className="text-orange-300">人工 review：</strong>
