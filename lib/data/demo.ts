...
export const demoPermissions: Permission[] = [
  ...
  { id: "perm_ai_workforce_view", key: "ai_workforce.view", name: "查看 AI 创新实验中心", module: "ai_workforce", action: "view", risk_level: "medium", description: "查看 Agent、Prompt、AI 调用与人工确认总览。" },
  { id: "perm_ai_workforce_manage", key: "ai_workforce.manage", name: "管理 AI 创新实验中心", module: "ai_workforce", action: "manage", risk_level: "high", description: "管理 AI 工作中心配置。" },
...
export const demoModules: ModuleDefinition[] = [
  ...
  { id: "mod_approvals", key: "approvals", name: "审批底层记录（已迁移）", description: "审批入口已迁移到财务能量中心、AI 创新实验中心和计划任务中心；本模块仅保留兼容记录。", icon: "ClipboardCheck", category: "system", status: "disabled", route: "/governance", required_permission: "governance.view", created_at: now, updated_at: now },
  ...
  { id: "mod_projects", key: "projects", name: "计划任务中心", description: "项目管理、任务分配、进度追踪、评论附件和项目复盘。", icon: "ListTodo", category: "core", status: "active", route: "/projects", required_permission: "projects.view", created_at: now, updated_at: now },
  { id: "mod_ai_workforce", key: "ai_workforce", name: "AI 创新实验中心", description: "Agent、Prompt、AI 调用、权限、质量、人工确认。", icon: "BrainCircuit", category: "ai", status: "active", route: "/ai-workforce", required_permission: "ai_workforce.view", created_at: now, updated_at: now },
