...
>(({ className, ...props }, ref) => (
  <textarea
      className={cn(
        ...
        "border-white/75 bg-white/76 shadow-[0_1px_0_rgba(255,255,255,0.9)_inset] backdrop-blur-xl focus-visible:border-cyan-200 focus-visible:bg-white focus-visible:shadow-[0_0_0_4px_rgba(103,232,249,0.14)]",
        className
      )}
    ref={ref}
    {...props}
