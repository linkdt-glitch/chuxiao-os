...
export const demoPermissions: Permission[] = [
  ...
  { id: "perm_energy_view", key: "energy.view", name: "查看组织能量系统", module: "energy", action: "view", risk_level: "low", description: "查看组织能量、成就和近期奖励。" },
  { id: "perm_energy_manage", key: "energy.manage", name: "管理组织能量设置", module: "energy", action: "manage", risk_level: "medium", description: "管理组织级动画和音效设置。" },
  { id: "perm_ai_workforce_view", key: "ai_workforce.view", name: "查看 AI 风暴创新实验室", module: "ai_workforce", action: "view", risk_level: "medium", description: "查看 Agent、Prompt、AI 调用与人工确认总览。" },
  { id: "perm_ai_workforce_manage", key: "ai_workforce.manage", name: "管理 AI 风暴创新实验室", module: "ai_workforce", action: "manage", risk_level: "high", description: "管理 AI 工作中心配置。" },
...
export const demoModules: ModuleDefinition[] = [
  ...
  { id: "mod_approvals", key: "approvals", name: "审批底层记录（已迁移）", description: "审批入口已迁移到财务能量中心、AI 风暴创新实验室和任务计划中心；本模块仅保留兼容记录。", icon: "ClipboardCheck", category: "system", status: "disabled", route: "/governance", required_permission: "governance.view", created_at: now, updated_at: now },
  ...
  { id: "mod_finance", key: "finance", name: "财务能量中心", description: "收入、支出、利润、现金流、经营健康度。", icon: "WalletCards", category: "core", status: "active", route: "/finance", required_permission: "finance.view", created_at: now, updated_at: now },
  { id: "mod_projects", key: "projects", name: "任务计划中心", description: "项目管理、任务分配、进度追踪、评论附件和项目复盘。", icon: "ListTodo", category: "core", status: "active", route: "/projects", required_permission: "projects.view", created_at: now, updated_at: now },
  { id: "mod_ai_workforce", key: "ai_workforce", name: "AI 风暴创新实验室", description: "Agent、Prompt、AI 调用、权限、质量、人工确认。", icon: "BrainCircuit", category: "ai", status: "active", route: "/ai-workforce", required_permission: "ai_workforce.view", created_at: now, updated_at: now },
  ...
  { id: "mod_energy", key: "energy", name: "组织能量系统", description: "记录小动作、里程碑和成就，让组织成长被看见。", icon: "Gem", category: "core", status: "active", route: "/energy", required_permission: "energy.view", created_at: now, updated_at: now },
...
export const demoProviders: AIProvider[] = [
  ...
  { id: "provider_siliconflow", organization_id: demoOrganization.id, provider_name: "siliconflow", label: "SiliconFlow DeepSeek V3", base_url: "https://api.siliconflow.cn/v1", model_name: "deepseek-ai/DeepSeek-V3", is_active: false, created_at: now, updated_at: now }
];
